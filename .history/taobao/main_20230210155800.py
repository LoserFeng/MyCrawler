...
def main():
    ...
    for product_id in product_id_list:
        ...
        comment_button=driver.find_element(By.XPATH,value='//*[@id="root"]/div/div[2]/div[2]/div[2]/div[1]/div/div/div[2]/span')
        comment_button.click()

        while driver.title == f'验证码拦截':
            logging.info('不是正确的页面，等待!')
            time.sleep(5)
        html_text = driver.page_source
        try:
