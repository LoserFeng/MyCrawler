...
def main():
    ...
    for i in range(0,TOTAL_PAGE):
        ...
        product_price_list.extend(re.findall(r'<i data-price="[0-9]*">([0-9.]*)</i>'),re.S)
        product_name_list.extend(re.findall(r'<a target="_blank" title="(.*?)" href="//item.jd.com/[0-9]*.html"',re.S))     
